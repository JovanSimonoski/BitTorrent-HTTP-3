...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--port", type=int, default=9999, help="The remote peer's port number"
    )
    parser.add_argument(
        "-k",
        "--insecure",
    ...
    parser.add_argument("--query-name", default="google.com", help="Domain to query")
    ...
    configuration = QuicConfiguration(is_client=True, alpn_protocols=['siduck'])
    if args.ca_certs:
